...
* 作  者   ：徐浩
* 生成日期 ：2025年10月27日
* 修改内容 ：对二合一浊度和COD传感器修改为浊度传感器代码 line 1931-1937
*            turb = tab_reg[0] * 0.1;
...
{   
    ...
    float  Humid_1 = -999, tempAir = -999, Light_1 = -999, CO2 = -999, NH3 = -999;
    ...
    char sensor_Humid_1_code[] = "a01002";    // Humidity 湿度
    char sensor_Light_1_code[] = "a01004";    // 光照
    char sensor_NH3_code[] = "a21001";   // NH3
    char sensor_CO2_code[] = "a05001"; //CO2
    ...
    while (1) {
        ...
        case 7: //从设备8 CO2传感器
            ...
            Humid_1 = tab_reg[0];
            sensor_data[9] = Humid_1 * 0.1;
            Humid_1 = sensor_data[9];
            ...
            Light_1 = float2decimal(a, b, c, d);
            sensor_data[12] = Light_1;
            sleep(2);
            break;
        ...
        if (index_flag == 12) {
           ...
           /* printf("溶解氧：%f mg/L\n氨氮：%f mg/L\n铜离子：%f μg/L\n镉离子：%f mg/L\n蓝绿藻：%f 万cells/mL\n叶绿素：%f mg/L\n电导率：%f μS/cm\nTDS：%f mg/L\n液位值：%f m\n浊度：%f NTU\n",
            ...
            printf("溶解氧：%f mg/L\n氨氮：%f mg/L\n铜离子：%f μg/L\n镉离子：%f mg/L\n蓝绿藻：%f 万cells/mL\n叶绿素：%f mg/L\n电导率：%f μS/cm\n液位值：%f m\n浊度：%f NTU\n",
                sensor_data[0], sensor_data[1], sensor_data[2], sensor_data[3], sensor_data[5], sensor_data[7], sensor_data[8], sensor_data[14], sensor_data[15]);
            printf("水温1：%f ℃\n水温2：%f ℃\n",
                sensor_data[4], sensor_data[6]);
            printf("环境湿度：%f %RH\n环境温度：%f ℃\nCO2：%f ppm\n光照:  %f Lux\nNH3：%f ppm\n",
                sensor_data[9], sensor_data[10], sensor_data[11], sensor_data[12], sensor_data[13]);
            printf("超声波风向：%f °\n超声波风速：%f m/s\n雨量：%f mm\n光照度：%f hlux\n环境温度：%f ℃\n环境湿度：%f %RH\n大气压力：%f hPa\n噪音：%f dB\n",
            ...
            sprintf((char*)ship_getpacket, "QN=%s;ST=%s;CN=%s;PW=%s;MN=%s;Flag=%s;CP=&&Gps=%s;  %s-Rtd=%010.3lf;%s-Rtd=%010.3lf;%s-Rtd=%010.3lf;%s-Rtd=%010.3lf;%s-Rtd=%010.3lf;%s-Rtd=%010.3lf;%s-Rtd=%010.3lf;%s-Rtd=%010.3lf;%s-Rtd=%010.3lf;%s-Rtd=%010.3lf;%s-Rtd=%010.3lf;%s-Rtd=%010.3lf;%s-Rtd=%010.3lf;%s-Rtd=%010.3lf;%s-Rtd=%010.3lf;%s-Rtd=%010.3lf;"
                ...
                sensor_Humid_1_code, Humid_1, sensor_tempAir_code,tempAir, sensor_CO2_code, CO2, sensor_Light_1_code, Light_1, sensor_NH3_code, NH3, sensor_depth_code, depth, sensor_turb_code, turb, \
            ...
            Humid_1 = -999, tempAir = -999, Light_1 = -999, CO2 = -999, NH3 = -999;
            depth = -999, turb = -999;
