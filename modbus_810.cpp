...
#define ZD_LAN_SERVER_IP        "192.168.31.101"          //中电莱斯传数据服务器ip
...
int get_sensor_data()
{
    ...
    while (1)  //一直读取数据
    {
        ...
        //数据段，原生数据
        sprintf((char*)temp_data_str, "QN=%s;ST=%s;CN=%s;PW=%s;MN=%s;Flag=%s;CP=&&%s-Rtd=%08d;%s-Rtd=%08d;%s-Rtd=%08d;%s-Rtd=%08d;%s-Rtd=%08d;%s-Rtd=%08d;%s-Rtd=%08d;%s-Rtd=%08.2lf;%s-Rtd=%08.2lf;%s-Rtd=%08.1lf;%s-Rtd=%08.1lf;%s-Rtd=%08.2lf;%s-Rtd=%08.2lf&&",
