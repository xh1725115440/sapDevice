all: modbus_gascar clean

modbus_gascar: modbus_gascar.o usbctl.o lora.o  bluetooth.o get.o protocol_process.o softwarewdt.o communicaManage.o registManage.o usart.o dataStore.o
	arm-linux-gnueabihf-g++ -o modbus_gascar modbus_gascar.o get.o usbctl.o lora.o  bluetooth.o protocol_process.o softwarewdt.o communicaManage.o registManage.o usart.o dataStore.o -L. -lmodbus -pthread -std=c++11 -Wl,--no-as-needed

modbus_gascar.o: modbus_gascar.cpp
	arm-linux-gnueabihf-g++ -c modbus_gascar.cpp  -pthread -std=c++11 -Wl,--no-as-needed
